...
path_data = '/data/KNW/KNW-stage/m.schepers/HCP/HCP_REST1_corr_mat_MI/'
path_export = '/data/KNW/KNW-stage/m.schepers/HCP/TDA_features_HCP_Females_Train_MI.csv'
...
# # data=data[0:1]
females = pd.read_csv('/data/KNW/KNW-stage/m.schepers/HCP/Cog_data/females_train.csv')
female_subjects = list(females['subject'])
