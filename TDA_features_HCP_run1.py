...
def euler_characeristic(matrix, subject, max_density, 
    ...
    Euler_resolution: the number of samples to estimate the Euler with. With large
        ...
        resolution of 1000.
    k_max: the maximum number of k-cliques to calculate. Lower values lowers
        computation time. 
...
# Paths for exporting
path_export = '/mnt/resource/m.schepers/Data/TDA_Data/'
path_plots = '/mnt/resource/m.schepers/Data/Plotting_Data/'
export_filename = 'Test_data_run1.csv'
